...
export default function AdminDashboard() {
  ...
  const colorPresets = [
    {
      name: "Gold Theme",
      colors: { background: "#f8dc82", text: "#212529", accent: "#FFD700" },
    },
    {
      name: "Blue Theme",
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="hidden lg:block text-center mt-6">
              <Button
                type="submit"
                className="bg-gradient-to-r from-jewelry-primary to-jewelry-secondary text-black px-8 py-4 text-lg  border-2 border-black  rounded-xl transition-all duration-300 
      hover:from-jewelry-secondary hover:to-jewelry-primary /* gradient swap on hover */
      hover:shadow-lg hover:scale-105     /* subtle hover effect */"
